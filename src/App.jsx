...
image_to_video_prompt: A Grok Imagine image-to-video prompt (80-120 words). This mode takes a character reference image as the starting frame and animates from it. Describe: (a) the character's appearance as seen in their master sheet (brief but specific — what they're wearing, their expression), (b) the location as described in the location master sheet (materials, lighting, key objects), (c) exactly what happens — the action, moment by moment, starting from the still image, (d) camera movement (Grok-compatible only), (e) audio per the scene's audio strategy. Follow same audio rules as the video paragraph. End with "cinematic, hyperreal, 4K film grain, 720p."
